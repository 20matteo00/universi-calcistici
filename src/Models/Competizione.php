...
class Competizione
{
    ...
    public function create(array $dati): int
    {
        ...
        $statement = $pdo->prepare("
            INSERT INTO Competizioni (IDUniverso, NomeCompetizione, Tipo, NumeroPartecipanti, Struttura)
            VALUES (:id_universo, :nome_competizione, :tipo, :numero_partecipanti, :struttura)
        ");
