...
<body>
    <div class="container py-4">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <h1 class="h3 mb-1">Crea collegamento tra competizioni</h1>
                ...
                <form method="post" action="/universi/<?= (int) ($universo['ID'] ?? 0) ?>/competizioni/collegamenti" id="collegamentoForm">
                    <div class="row g-4">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="border rounded p-3">
                                ...
                                <textarea
                                    ...
                                    name="dettagli"
                                    rows="14"
                                    placeholder='{"criterio":"posizione","da":1,"a":2}'><?= htmlspecialchars((string) ($vecchiDati['dettagli'] ?? '')) ?></textarea>

                                <div class="form-text mt-2">
                                    Questo JSON descrive solo chi passa da una competizione all'altra.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-primary">Salva collegamento</button>
