...
<body>
    <div class="container py-4">
        <div class="mb-4">
            <a href="/universi/<?= (int) ($universo['ID'] ?? 0) ?>/competizioni/<?= (int) ($competizione['ID'] ?? 0) ?>" class="text-decoration-none">← Torna alla competizione</a>
        </div>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form
                    method="post"
                    action="/universi/<?= (int) ($universo['ID'] ?? 0) ?>/competizioni/<?= (int) ($competizione['ID'] ?? 0) ?>/update"
                    id="competizioneForm">
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="border rounded p-3">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <select
                                            class="form-select js-struttura-field"
                                            id="tipo"
                                            name="tipo"
                                            required>
                            ...
                            <div class="border rounded p-3">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-text mt-2">
                                        Ordina i criteri dall'alto verso il basso.
                                    </div>
                    ...
                    <div class="d-flex gap-2 mt-4">
                        ...
                        <a href="/universi/<?= (int) ($universo['ID'] ?? 0) ?>/competizioni/<?= (int) ($competizione['ID'] ?? 0) ?>" class="btn btn-outline-secondary">Annulla</a>
                    </div>
                </form>
            </div>
        </div>
