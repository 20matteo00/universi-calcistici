    ...
    <div class="container py-4">
        <div class="mx-auto">
            ...
            <div class="mb-4">
                ...
                <h1 class="h2 mb-1">Modifica giocatore</h1>
                <p class="text-muted mb-0">Stai modificando il giocatore ID <?= (int) ($giocatore['ID'] ?? 0) ?>.</p>
            </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    ...
                    <form action="/giocatori/modifica/<?= (int) ($giocatore['ID'] ?? 0) ?>" method="post" class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="d-flex flex-column flex-sm-row gap-2 pt-2">
                                <button class="btn btn-primary" type="submit">Aggiorna giocatore</button>
