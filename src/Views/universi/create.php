    ...
    <div class="container py-4">
        <div class="mx-auto">
            ...
            <div class="mb-4">
                ...
                <h1 class="h2 mb-1">Crea universo</h1>
                <p class="text-muted mb-0">Inserisci il nome e una descrizione iniziale del nuovo universo calcistico.</p>
            </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    ...
                    <form action="/universi/crea" method="post" class="row g-3">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <textarea
                                ...
                                name="descrizione"
                                class="form-control"
                                rows="6"><?= htmlspecialchars((string) ($vecchiDati['descrizione'] ?? '')) ?></textarea>
                        </div>

                        <div class="col-12">
                            <div class="d-flex flex-column flex-sm-row gap-2 pt-2">
                                <button class="btn btn-primary" type="submit">Salva universo</button>
